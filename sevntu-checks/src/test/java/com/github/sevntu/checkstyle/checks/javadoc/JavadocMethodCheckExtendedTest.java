...
public class JavadocMethodCheckExtendedTest extends BaseCheckTestSupport
{
    ...
    public void setUp()
    {
        mCheckConfig = createCheckConfig(JavadocMethodCheckExtended.class);
    }
    ...
    public void testScopes() throws Exception
    {
        ...
        verify(mCheckConfig, getPath("InputNoJavadoc.java"), expected);
    }
    ...
    public void testSetterGetterOff() throws Exception
    {
        ...
        verify(mCheckConfig, getPath("InputSetterGetter.java"), expected);
    }
    ...
    {
        final String[] expected = {};
        verify(mCheckConfig, getPath("Input_01.java"), expected);
    }
    ...
    {
        final String[] expected = {};
        verify(mCheckConfig, getPath("Input_02.java"), expected);
    }
    ...
    public void test_1168408_3() throws Exception
    {
        ...
        mCheckConfig.addAttribute("allowUndeclaredRTE", "true");
        final String[] expected = {};
        verify(mCheckConfig, getPath("Input_03.java"), expected);
    }
    ...
    public void test_generics_1() throws Exception
    {
        ...
        verify(mCheckConfig, getPath("TestGenerics.java"), expected);
    }
    ...
    public void test_1379666() throws Exception
    {
        ...
        mCheckConfig.addAttribute("allowUndeclaredRTE", "true");
        final String[] expected = {};
        verify(mCheckConfig, getPath("Input_1379666.java"), expected);
    }
    ...
    public void testInheritDoc() throws Exception
    {
        ...
        verify(mCheckConfig, getPath("InputInheritDoc.java"), expected);
    }
}
